...
if (!version.includes("APP_VERSION = '7.22.4'")) throw Error('Application version is stale');
...
for (const swFile of ['sw.js', 'service-worker.js']) {
    ...
    if (!content.includes("black-sword-v7.22.4")) throw Error(`${swFile} cache version is stale`);
}
