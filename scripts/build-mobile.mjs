...
await copyFile(new URL('../AUDIO_CREDITS.md',import.meta.url),new URL('../www/AUDIO_CREDITS.md',import.meta.url));
console.log('Capacitor/web assets and deployable audio credits prepared in www/');
